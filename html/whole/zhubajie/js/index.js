...
window.onload=function(){
	...
	var oHeader1=document.getElementById('header-1');
	...
	window.onscroll=function(){
        ...
        if(scrollTop>=top){
            //吸住
            oHeader1.style.position='fixed';
            oHeader1.style.top='0';
            oHeader1.style.left='0';
            oHeader1.style.zIndex=100;
            oHeader1.style.background='#fff';
            oHeader.style.display='block';
        }else{
            //回去
            oHeader1.style.position='static';
